...
<body>
	<div>
		<div></div>
		<div class="text_bold w3-right-align" style="font-size: 14pt; font-style: italic">NBC FORMS</div>
		<div style="font-size: 8pt">NBC FORM NO. A-04</div>
		...
		<div class="w3-center text_bold" style="font-size: 16pt">MECHANICAL PERMIT</div>
		<div class="w3-row">
		...
		<div class="text_bold" style="margin-top: 50px">BOX 1. (TO BE ACCOMPLISHED IN PRINT BY THE OWNER/APPLICANT)</div>
